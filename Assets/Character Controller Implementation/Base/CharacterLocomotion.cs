...
public class CharacterLocomotion : MonoBehaviour
{
    ...
    public float Radius { get => _cc.radius; }

    public Vector3 ColliderPosition { get => transform.TransformPoint(_cc.center); }
    ...
    //This method was created to support steering movement from IA Characters.
